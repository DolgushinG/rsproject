                                            ...
                                            <div class="col-sm-10">
                                                @for($i = 5; $i >= 1; $i--)
                                                    @if($i === intval($user->average_rating))
                                                        <input class="stars star-{{$i}}" value="{{$i}}"
                                                               id="star-{{$user->id+1}}"
                        ...
                        <div class="bg-white rounded shadow-sm p-4 mb-5 rating-review-select-page">
                            <form action="{{route('postrating')}}" method="POST" class="php-email-form">
                                ...
                                <div class="col-sm-2" style="margin-left: -20px">
                                    <input class="star star-5" value="5" id="star-b{{$user->id}}"
                                           data-id="{{$user->id}}"
                                           type="radio" name="star"/>
                                    <label class="star star-5" for="star-b{{$user->id}}"></label>
                                    <input class="star star-4" value="4" id="star-v{{$user->id}}"
                                           data-id="{{$user->id}}"
                                           type="radio" name="star"/>
                                    <label class="star star-4" for="star-v{{$user->id}}"></label>
                                    <input class="star star-3" value="3" id="star-c{{$user->id}}"
                                           data-id="{{$user->id}}"
                                           type="radio" name="star"/>
                                    <label class="star star-3" for="star-c{{$user->id}}"></label>
                                    <input class="star star-2" value="2" id="star-x{{$user->id}}"
                                           data-id="{{$user->id}}"
                                           type="radio" name="star"/>
                                    <label class="star star-2" for="star-x{{$user->id}}"></label>
                                    <input class="star star-1" value="1" id="star-z{{$user->id}}"
                                           data-id="{{$user->id}}"
                                           type="radio" name="star"/>
