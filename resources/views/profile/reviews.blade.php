<div class="col-md-9">
    <div class="tab-content">
        <form id="infoForm">
            @csrf
            <div class="tab-pane fade active show" id="account-info" style="padding: 14px;
    padding-bottom: 45px;">
                <div class="card-body">
                                ...
                                @foreach($categories as $category)
                                    <label class="check">
                                        <input type="checkbox" name="categories[{{$category->id}}]"
                                               value="{{$category->id}}" checked> <span
                                            style="border-radius: 15px">{{$category->category_name}}</span></label>
                                @endforeach
...
<div class="tab-pane active show" id="tab-reviews">
    <div class="alert alert-info alert-dismissible" role="alert">
        ...
        <div class="alert-message"><span><strong>Info!</strong> Lorem Ipsum is simply dummy text.</span>
        </div>
    </div>
    <table class="table table-hover table-striped">
        <tbody>
        <tr>
            <td><span class="float-right font-weight-bold">3 hrs ago</span> Here
        ...
        <tr>
            <td><span class="float-right font-weight-bold">9/10</span> Porttitor
                vitae ultrices quis, dapibus id dolor. Morbi venenatis lacinia
                rhoncus.
            </td>
        </tr>
        <tr>
            <td><span class="float-right font-weight-bold">9/4</span> Vestibulum
