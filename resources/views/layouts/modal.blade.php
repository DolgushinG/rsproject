                        ...
                        <div class="col-lg-4">
                            <div class="login-register-form-area">
                                <div class="login-tab-menu">
                                    <ul class="nav">
                                        <li><a class="active show" data-toggle="tab" href="index.html#login">Login</a></li>
                                        <li><a data-toggle="tab" href="index.html#register">Register</a></li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="login-register-form">
                                            ...
                                            <div class="social-login">
                                                <ul class="social-icon">
                                                    <li><a class="facebook" href="index.html#"><i class="fab fa-facebook"></i></a></li>
                                                    <li><a class="twitter" href="index.html#"><i class="fab fa-twitter"></i></a></li>
                                                    <li><a class="linkedin" href="index.html#"><i class="fab fa-linkedin"></i></a></li>
                                                    <li><a class="google" href="index.html#"><i class="fab fa-google-plus"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row row-5">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="register-account">
                                                            ...
                                                            <label for="register-terms-conditions">I read and agree to the <a href="index.html#">Terms &amp; Conditions</a> and <a href="index.html#">Privacy Policy</a></label>
                                                        </div>
                                                    </div>
