                ...
                <div class="modal-body">
                    ...
                    <form id="create_event_frm" action="{{route('event')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-5 col-xs-12">
                                    <div class="form-group">
                                        <input type="text" name="event_start_date" required="" id="event_start_date"
                                               value="" class="form-control date_pick" placeholder="Start Date">
                                    </div>
                                </div>
                                <div class="col-lg-2 col-xs-2">
                                    <div id="start_time_toggle">
                                        <button type="button" class="btn btn-md" title="Add Start Time"
                                                onclick="add_start_time()">
                                ...
                                <div class="col-lg-5 col-xs-12" id="event_start_time_area" style="display: none">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="event_start_time" id="event_start_time"
                                               value="12:00 AM" class="form-control time_pick" placeholder="Start Time">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-2 col-xs-2">
                                    <div id="end_date_toggle">
                                        <button type="button" class="btn btn-md" onclick="add_end_date()"
                                                style="width: 117px">
                                            <i class="text-success fa fa-plus"></i> End Date
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pull-left" style="width: 75%;">
                                <div class="col-lg-5 col-xs-12">
                                    <div class="form-group">
                                        <input type="text" name="event_end_date" id="event_end_date" value=""
                                               class="form-control date_pick" placeholder="End Date">
                                    </div>
                                </div>
                                <div class="col-lg-2 col-xs-2">
                                    <div id="end_time_toggle">
                                        <button type="button" class="btn btn-md" title="Add End Time"
                                                onclick="add_end_time()">
                                            <i class="text-success fa fa-plus"></i>
                                            <i class="text-success fa fa-clock"></i>
                                        </button>
                                    </div>
                                ...
                                <div class="col-lg-5 col-xs-12" id="event_end_time_area" style="display: none">
                                    ...
                                    <input type="text" name="event_end_time" id="event_end_time" value="11:59 PM"
                                           class="form-control time_pick" placeholder="End Time">
                                </div>
                            </div>
                            <div class="pull-right">
                                <div class="col-lg-2 col-xs-2">
                                    <button type="button" class="btn btn-md" onclick="remove_end_date()"
                                            style="width: 117px"><i class="text-danger fa fa-times"></i> Remove
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="section row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input class="form-control" id="event_city" name="event_city"
                                              placeholder="city">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="card-body text-center">
                                    <h3>Облаcть соревнований</h3>
                                    @foreach($categories as $category)
                                        <label class="check">
                                            <input type="checkbox" id="event_categories" name="event_categories[{{$category->id}}]" value="{{$category->id}}" unchecked> <span style="border-radius: 15px">{{$category->category_name}}</span></label><br>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                    ...
                    <form id="edit_event_frm" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="pull-left" style="width: 75%;">
                                <div class="col-lg-5 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="event_start_date" required=""
                                               id="edit_event_start_date" value="" class="form-control date_pick"
                                               placeholder="Start Date">
                                    </div>
                                </div>
                                <div class="col-lg-2 col-xs-2">
                                    <div id="edit_start_time_toggle" class="mt30">
                                        <button type="button" class="btn btn-md" title="Remove Start Time"
                                                onclick="edit_remove_start_time()">
                                ...
                                <div class="col-lg-5 col-xs-12" id="edit_event_start_time_area" style="display: block">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="event_start_time" id="edit_event_start_time" value=""
                                               class="form-control time_pick" placeholder="Start Time">
                                    </div>
                                </div>
                            </div>
                            <div class="pull-right">
                            ...
                            <div class="pull-left" style="width: 75%;">
                                <div class="col-lg-5 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="event_end_date" id="edit_event_end_date" value=""
                                               class="form-control date_pick" placeholder="End Date">
                                    </div>
                                </div>
                                <div class="col-lg-2 col-xs-2">
                                    <div id="edit_end_time_toggle" class="mt30">
                                        <button type="button" class="btn btn-md" title="Remove End Time"
                                                onclick="edit_remove_end_time()">
                                            <i class="text-danger fa fa-times"></i>
                                            <i class="text-danger fa fa-clock"></i>
                                        </button>
                                    </div>
                                ...
                                <div class="col-lg-5 col-xs-12" id="edit_event_end_time_area" style="display: block">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="event_end_time" id="edit_event_end_time" value=""
                                               class="form-control time_pick" placeholder="End Time">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="">Event City</label>
                                    <input class="form-control" id="edit_event_city" name="event_city"
                                              placeholder="City">
                                </div>
                            </div>
                        </div>
        ...
        function get_data() {
            ...
            $.get(event_url, function (r) {
                ...
                $.each(ad, function (i, item) {
                    ...
                    html += '<td>' + ad[i].event_city+ '</td>';
                    html += '<td>' + ad[i].event_url + '</td>';
                    html += '<td>' + ad[i].events_categories + '</td>';
        ...
        function edit_event(event_id) {
            ...
            $.get(single_event_url, function (r) {
                ...
                if (edata.id > 0) {
                    ...
                    $('#edit_event_city').val(edata.event_city);
                    $('#edit_event_url').val(edata.event_url);
