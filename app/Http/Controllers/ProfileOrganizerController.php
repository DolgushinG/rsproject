...
class ProfileOrganizerController extends Controller
{
    ...
    public function dashboard() {
        ...
        return view('profileOrganizer.dashboard', compact('organizer'));
    }
    ...
    public function ContentCreateEvent() {
        $organizer = User::find(Auth()->user()->id);
        $grades = Grade::all();
        $categories = Category::all();
        return view('profileOrganizer.create_event', compact(['grades', 'categories', 'organizer']));
    }
