...
class FeedbackContoller extends Controller
{
    ...
    protected function grid()
    {
        ...
        $grid->id('ID');
        $grid->name_guest('name_guest');
        $grid->email_guest('email_guest');
    ...
    protected function detail($id)
    {
        ...
        $show->id('ID');
        $show->name_guest('name_guest');
        $show->email_guest('email_guest');
    ...
    protected function form()
    {
        ...
        $form->display('ID');
        $form->text('name_guest', 'name_guest');
        $form->text('email_guest', 'email_guest');
